...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycby1mNbWb7waZLjz1qU9-1ISXXHmsM0gIDtvb_K0QcP5lPRvr-SRK8Lni5-VSYgAGzSB9g/exec";
...
// Girls left blank — Jay doesn't have a co-leader yet. Once one is
  ...
  return (
    <div className="home-wrap">
      <div className="home-hero">
        <span className="eyebrow">Jay Abraham's Cell Report</span>
    ...
    <div className="shell" data-textsize={textSize}>
      ...
      <header className="topbar">
        <button className="brand" onClick={goHome}>
          ...
          <span className="brand-name">Jay Abraham's Cell Report</span>
        </button>
